...
![查看显卡](./figures\Nvidia-1699188023815-8.png)



**linux：**

![Linux查看GPU](./figures\Linux_GPU-1699188023815-9.png)

我们需要看下版本号，看自己可以兼容的CUDA版本，等会安装PyTorch时是可以向下兼容的。具体适配表如下图所示。

![适配表](./figures/table-1699188023815-10.png)
...
<img src="./figures\choose_envs-1699188023815-13.png" align="center" style="zoom:80%;" />
